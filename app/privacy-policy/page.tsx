...
export default function PrivacyPolicy() {
  return (
    <div className="max-w-2xl mx-auto p-4">
      ...
      <p>This privacy policy applies to the Pync Partner App app (hereby referred to as &quot;Application&quot;) for mobile devices that was created by Pync (hereby referred to as &quot;Service Provider&quot;) as a Free service. This service is intended for use &quot;AS IS&quot;.</p>
      ...
      <p>The Application collects your device&apos;s location, which helps the Service Provider determine your approximate geographical location and make use of it in the following ways:</p>
      <ul className="list-disc list-inside pl-4 mb-4">
      ...
      <p>For a better experience, while using the Application, the Service Provider may require you to provide us with certain personally identifiable information, including but not limited to your phone number and name. The information that the Service Provider requests will be retained by them and used as described in this privacy policy.</p>
      ...
      <p>The Service Provider will retain User Provided data for as long as you use the Application and for a reasonable time thereafter. If you&apos;d like them to delete User Provided Data that you have provided via the Application, please contact them at <a href="mailto:mayank@pync.in" className="text-blue-500 underline">mayank@pync.in</a> and they will respond in a reasonable time.</p>
      ...
      <p>This privacy policy is effective as of 2024-08-11</p>
      ...
      <p>If you have any questions regarding privacy while using the Application, or have questions about our practices, please contact the Service Provider via email at <a href="mailto:mayank@pync.in" className="text-blue-500 underline">mayank@pync.in</a>.</p>
    </div>
  );
}
