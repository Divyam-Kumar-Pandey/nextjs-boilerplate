...
const InfoCards = ({
  ...
  return (
    <div className="flex gap-5 ">
        {/* Vehicle Card */}
        <div className="bg-[#e2e5e4] rounded-lg shadow-sm px-5 py-3 flex flex-col gap-2 justify-center">
            <span className="text-[#00669b] font-semibold">{vehicleName}</span>
        ...
        <div className="bg-[#ffd994] rounded-lg shadow-sm px-5 py-3 relative gap-3 flex flex-col min-w-48">
